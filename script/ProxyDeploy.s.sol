 ...
 * @notice Deploys the Exchange contract using OpenZeppelin's Transparent Proxy pattern
 * @dev This script follows OpenZeppelin's best practices for proxy deployment:
...
contract ProxyDeployScript is Script {
    ...
    //
    // Run script with:
    // forge script script/ProxyDeploy.s.sol:ProxyDeployScript --rpc-url $RPC_URL --private-key $PRIVATE_KEY --broadcast --verify
